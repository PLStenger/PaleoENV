...
DATABASE=/home/plstenge/PaleoENV/98_database_files
TMPDIR=/scratch_vol0
...
# Note: max-depth should be chosen based on ConTable.qzv (or on /home/plstenge/PaleoENV/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
